        ...
        try {
          ...
          await client.query(
            ...
            [
              ...
              results.lhr.audits['third-party-summary'].details.summary
                .wastedBytes,
              results.lhr.audits['third-party-summary'].details.summary
                .wastedMs,
